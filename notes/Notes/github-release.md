...
| Release | Tag | 对应提交 | 说明 |
|---------|-----|---------|------|
| v1.0 — Classic | v1.0 | `afc06ff` | 初始版本，data.js 内嵌题库，Python 解析 Word |
| v2.0 — Ultra 网页版 | v2.0 | `75b3ca4` | 纯静态 SPA 重构，侧栏题库管理 + 多题型导入 |
| v3.0 — Ultra 全栈版 | v3.0 | `abbe119` | Cloudflare 全栈（D1+KV+Pages Functions），用户/好友/管理面板 |
